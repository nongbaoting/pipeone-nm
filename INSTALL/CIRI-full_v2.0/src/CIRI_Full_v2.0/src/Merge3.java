...
public class Merge3 {
	...
	public Merge3(String ciri1,String ciri_as1,String ciri_ro1, String gtf1, String ref1,String out1) {
		 this.ciri=ciri1;
		 ...
		 //       writeStream.newLine();
		        ...
		        while(line!=null){
		        	...
		        	if(as_ro_result.containsKey(tmpf[0])){
		        		...
		        		int o=0;
		        		int[] jstart=new int[100];
		        		int[] jend=new int[100];
				...
				int[][] exonstart=new int[30000][100];
			    int[][] exonend=new int[30000][100];//[junction number][exonnumber]
			    int[][] exonstate=new int[30000][100];//0,1=left ,2=right
			    int[] readsnum=new int[30000];//reads
			    int[] readsnum2=new int[30000];
			    String[] chr=new String[30000];
			    int[] start =new int[30000];
			    int[] end= new int[30000];
			    String[][] readname=new String[30000][500];
			    int total=0;
