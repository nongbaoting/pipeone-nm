...
process Fastp {
    ...
    output:
    tuple val(id), path("${id}_1.fastp.fq.gz"), path("${id}_2.fastp.fq.gz"), emit: cleaned_reads
    ...
    fastp -i ${id}_1.fastq -I ${id}_2.fastq -o ${id}_1.fastp.fq.gz -O ${id}_2.fastp.fq.gz \\
